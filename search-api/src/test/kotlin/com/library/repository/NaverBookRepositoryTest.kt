...
class NaverBookRepositoryTest {
    ...
    fun `search 호출시 적절한 데이터형식으로 변환한다`() {
        ...
        val response = NaverBookResponse(
            ...
            start = 1,
            display = 2,
            lastBuildDate = "Wed, 13 May 2026 11:13:21 +0900",
            items = items
        )
        ...
        assertThat(result.contents[0].pubDate).isEqualTo(LocalDate.of(2026, 1, 1))
        ...
        assertThat(result.contents[1].pubDate).isEqualTo(LocalDate.of(2026, 1, 2))
